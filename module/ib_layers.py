'''
The original implimentation is from icml 2018 paper 'Compressing Neural Network using the information
bottleneck, we use the reparamterization trick for estimate the importance of hidden neurals.
'''
